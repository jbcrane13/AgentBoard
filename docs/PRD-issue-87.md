# PRD: Kanban create sheet: assignee field should be a pick list, not free text

## Issue
#87 in jbcrane13/agentboard
## Tasks
- [x] Write failing tests that define expected behavior
- [x] Implement Kanban create sheet: assignee field should be a pick list, not free text to pass tests
- [x] Handle edge cases
