...
struct GitServiceParserTests {
    ...
    func parseCommitRecordsTagPlusBranchPrefersBranch() {
    ...
    func parseCommitRecordsTagOnlyUsesTag() {
    ...
    func parseCommitRecordsEmptyRefsNilBranch() {
    ...
    func parseCommitRecordsBeadIDsWithDotSuffix() {
    ...
    func parseCommitRecordsDeduplicatesBeadIDs() {
    ...
    func parseCommitRecordsHeadBranchStrippedCorrectly() {
    ...
    func parseCommitRecordsEmptyInput() {
        let service = GitService()
        let commits = service.parseCommitRecords(from: "")
